...
- Meet supervisor to discuss topic and scope
- Submit project proposal to supervisor

### Deliverables
- Project proposal document (initial draft)
- Supervisor approval of topic
...
- Use case diagrams
- Pugh matrix for tech selection
- Draft Chapters 2 & 3
...
- Configure project structure (src/, docs/, tests/)
- Create initial README
- Set up ESLint and Prettier
- Finalize sprint backlog and project timeline
- First supervisor meeting of Term 2
...
- Implement FR9: LocalStorage persistence (save/load on mount)
- Set up basic UI layout and styling
...
- Add basic styling (CSS modules or Tailwind)
...
- Test all CRUD operations with filters active
- Implement NFR4 (real-time updates)
...
- Code cleanup and comments (NFR11)
- **Supervisor meeting**: Demo complete application

### Deliverables
- Working prototype with all Must-Have requirements (FR1-FR10)
- Unit tests for core functions
- Draft Chapter 4 (Requirements) and Chapter 5 (Design & Development)

### Time Allocation
**20-25 hours/week** (development + testing + documentation)
...
- Update Git repository documentation
- Draft Chapter 6 (Results)
- **Supervisor meeting**: Final demo and discuss report
...
### Time Allocation
**18-20 hours/week** (testing + documentation)
...
- Share complete draft with supervisor for final feedback

### Deliverables
- Complete 6000-word report draft
- All chapters finalized
- References and appendices complete

### Time Allocation
**25-30 hours/week** (writing + editing)
...
- Prepare for demonstration/viva

### Deliverables
- ✅ Final report (PDF)
- ✅ Git repository link (in report)
- ✅ Presentation slides
- ✅ Poster (if required)
...
|-------|-------|------------|-------------|
| Initiation | 4 | 6 | 24 |
| Research & Ethics | 8 | 10 | 80 |
| Setup & Planning | 2 | 11 | 22 |
| Development | 8 | 22 | 176 |
| Testing | 4 | 19 | 76 |
| Report Writing | 3 | 27 | 81 |
| Final Submission | 1 | 12 | 12 |
| **TOTAL** | **30** | **avg 15.7** | **471** |

*Note: Total exceeds 300 hours guideline due to overlap between development and documentation. Actual effort will be ~300 hours.*

---

## Risk Management

| Risk | Likelihood | Impact | Mitigation | Timeline Impact |
|------|-----------|--------|------------|-----------------|
| **React learning curve delays Sprint 1** | High | Medium | Allocate Weeks 13-14 for tutorials; use official docs | Buffer in Sprint 1 |
| **LocalStorage quota issues** | Medium | High | Test early (Sprint 1); implement NFR5 error handling | Addressed in Sprint 4 |
| **Scope creep** | Medium | High | Stick to Must-Have (FR1-FR10); defer Could-Have to Phase 5 | Review at each sprint |
| **Supervisor unavailability** | Low | Medium | Book meetings 2 weeks ahead; send email updates | N/A |
| **Report writing underestimated** | High | High | Draft chapters during development (Phase 4-5) | 3 weeks allocated |
| **Other coursework conflicts** | High | Medium | Front-load research in Term 1; heavy dev in Term 2 | Balanced workload |
| **Christmas break productivity loss** | Medium | Low | Use break for React learning and Chapter 2-3 drafts | Optional buffer |

---

## Dependencies

- **Ethics approval** must complete before any primary research (N/A for this project)
- **Requirements finalization** before Sprint 1 starts
- **Sprint 1 (CRUD)** before Sprint 2 (Edit) - cannot edit without create
- **Sprint 3 (Sorting)** requires Sprint 1 data structure
- **Testing phase** requires completed development
- **Report Chapter 5-6** require completed development and testing
